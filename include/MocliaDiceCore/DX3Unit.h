...
namespace Moclia
{
    ...
    private:
        ...
        * */
        static void addDiceCalc(int64_t general, int64_t addup, int64_t surface, int64_t &totalResult, std::string &iterationCalc, std::string &middleCalc, int64_t lastAdd, std::string &exception);
